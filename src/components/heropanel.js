            ...
            <div className='wrap-container'>
              <div className="columns is-multiline is-vcentered hero-panel-container">
                <div className="column is-6-widescreen is-6-desktop is-12-tablet is-12-mobile">
                  ...
                  <p className='p2'>Pixel-Perfect Web Developer | HTML5, CSS, JavaScript | React JS | Bulma & Bootstrap Expert | SEO & Analytics Integration | Ghost & Pipedrive Integration Specialist</p>
                ...
                <div className="column is-6-widescreen is-6-desktop is-12-tablet profile-pic-container">
                  <figure>
                    <img className='profile-pic' src={`${process.env.PUBLIC_URL}/images/profile_pic.png`} width={300} height={300} />
                  </figure>
                </div>
              </div>
            </div>
